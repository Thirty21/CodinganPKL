...
// Menampilkan semua data dari table pelapor berdasarkan nik secara Descending
...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase">Form surat kehilangan data berharga</h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold text-uppercase" id="detail">Detail Data Pelapor</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body text-center" id="detail-pelapor">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            ...
            <div class="col-md-6 col-sm-8 my-2 text-center link">
    ...
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class="bi bi-suit-heart-fill" style="color: purple;"></i> by <u style="color: white;">Ahdi Khalida Fathir</u></p>
    </footer>
    <!-- Close Footer -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.detail').click(function() {
                var dataPelapor = $(this).attr("data-id");
                $.ajax({
                    url: "detail.php",
                    method: "post",
                    data: {
